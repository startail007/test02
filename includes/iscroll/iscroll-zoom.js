...
// INSERT POINT: _translate
	...
	_zoomStart: function (e) {
		...
		this.originX = Math.abs(e.touches[0].pageX + e.touches[1].pageX) / 2 + this.wrapperOffset.left - this.x - this.WheelMyX;
		this.originY = Math.abs(e.touches[0].pageY + e.touches[1].pageY) / 2 + this.wrapperOffset.top - this.y - this.WheelMyY;
